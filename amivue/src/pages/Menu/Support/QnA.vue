		...
		<div class="accordion-wrap">
			<div class="wbox">
				...
				<b-collapse id="my-collapse">
					<div class="">A</div>
					<p>
						정기 검침일은 매년 1월, 6월입니다. 월검침일 매월 23일이여, 해당 지역에 따라 달라 질수 있습니다. 검침 메뉴에서 월검침을 선택하시면
						계량기에서 정기검침일로 설정되어진 정기검침 정보와 검침일 기준으로 00시 00분 데이터를 기반으로 한 월 검침을 확인 할 수 있습니다. 검침
						메뉴에서 월검침을 선택하시면 계량기에서 정기검침일로 설정되어진 정기검보는 웹에서 확인이 가능합니다.
					</p>
				</b-collapse>
			</div>
			<div class="wbox">
