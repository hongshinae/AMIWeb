<template>
	<div class="main-bg content">
		<div class="main-location-wrap">
			<h1>검침 조회</h1>
			<div class="tap-wrap">
				<b-button pill :variant="activeTab(0)" @click="tabIndex = 0">검침 주기별 데이터</b-button>
				<b-button pill :variant="activeTab(1)" @click="tabIndex = 1">시간별 데이터</b-button>
				<b-button pill :variant="activeTab(2)" @click="tabIndex = 2">기간 조회</b-button>
			</div>
